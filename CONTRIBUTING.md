...
```bash
# Type-check everything + run all 1467 tests
...
│   └── NeoHub.*/                    # 5 L1 contract projects (4-pillar lean architecture: RollupHub, SharedBridge, ZkVerifier, GovernanceController, Sp1Groth16Verifier)
