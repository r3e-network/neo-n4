...
| Contracts | 24 original bundle re-verified (24/24 reuse + smoke 2026-07-18 session7); SharedBridge **fixed** redeployed as new hash |
...
| SharedBridge deposit | **live fixed**: bridge `0xf64548c2…1bae`; Deposit nonces 1–8 HALT with `WitnessScope.Global` (`0x9b72709e…4675ae`, `0x77ea50a9…fe6f31`, `0xa06e7952…e6d821`, `0xd33952c5…2b1294`, `0xf9539490…2bd9bb`, `0x55ccf7b1…61cd`, `0xde9e3342…e4b8`, `0xa30e573b…bebc`). Session7 reverify 24/24 reuse + 29 postdeploy + 42 smoke (2026-07-18). Legacy `0xf2f5114b…b241` still broken. Chain `20260716` config still points at legacy until governance retarget (**funded/governance gate**). |
