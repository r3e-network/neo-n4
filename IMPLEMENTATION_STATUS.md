...
| `Neo.Plugins.L2Prover.UnitTests`     | 19    | `L2ProverPlugin` lifecycle, ProofType resolution, **CreateFromChainDirectory / CreateMultisigWired / CreateZkWired**, Wire dispatch Multisig/Zk/Optimistic/None |
