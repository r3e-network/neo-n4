...
| Tests             | **879 / 27 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 879 tests (~10 seconds)
