...
| Tests             | **756 / 28 projects**  | Module-level unit tests + integration tests + contract tests; all green |
...
# Type-check everything + run all 756 tests (~10 seconds)
