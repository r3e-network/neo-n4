...
| Tests             | **866 / 26 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 866 tests (~10 seconds)
