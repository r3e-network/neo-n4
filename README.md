...
| Tests             | **1035 / 29 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1035 tests (~10 seconds)
