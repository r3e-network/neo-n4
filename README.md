...
| Tests             | **1067 / 29 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1067 tests (~10 seconds)
