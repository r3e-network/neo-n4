...
| Tests             | **847 / 26 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 847 tests (~10 seconds)
