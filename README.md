...
| Tests             | **1165 / 30 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1165 tests (~10 seconds)
