...
| Tests             | **840 / 26 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 840 tests (~10 seconds)
