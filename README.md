...
| Tests             | **677 / 25 projects**  | Module-level unit tests + integration tests + contract tests; all green |
...
# Type-check everything + run all 677 tests (~10 seconds)
