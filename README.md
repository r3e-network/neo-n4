...
| Tests             | **1075 / 29 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1075 tests (~10 seconds)
