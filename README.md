...
| Tests             | **1074 / 29 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1074 tests (~10 seconds)
