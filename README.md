...
| Tests             | **877 / 27 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 877 tests (~10 seconds)
