...
| Tests             | **1174 / 30 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1174 tests (~10 seconds)
