...
| Tests             | **700 / 27 projects**  | Module-level unit tests + integration tests + contract tests; all green |
...
# Type-check everything + run all 700 tests (~10 seconds)
