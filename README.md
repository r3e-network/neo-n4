...
| Tests             | **780 / 28 projects**  | Module-level unit tests + integration tests + contract tests; all green |
...
# Type-check everything + run all 780 tests (~10 seconds)
