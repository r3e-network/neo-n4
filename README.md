...
| Tests             | **851 / 26 projects**  | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 851 tests (~10 seconds)
