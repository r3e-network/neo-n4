...
| Tests             | **694 / 26 projects**  | Module-level unit tests + integration tests + contract tests; all green |
...
# Type-check everything + run all 694 tests (~10 seconds)
