...
| Tests             | **1325 / 33 projects** | Module-level unit tests + integration tests; all green |
...
# Type-check everything + run all 1325 tests (~10 seconds)
