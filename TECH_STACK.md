...
|----------|------:|-------|
| Smart contracts — NeoHub L1 suite | 5 | `contracts/NeoHub.*/` (5 production contracts: RollupHub, SharedBridge, ZkVerifier, Sp1Groth16Verifier, GovernanceController) |
...
| Top-level documentation pages | 47 EN + 57 zh | Current `docs/*.md`, `docs/zh/*.md`; nested guides are additional |
...
| Smart contract artifacts | All 4 NeoHub projects compile; the 4 production artifacts are generated by the deployment bundle |
