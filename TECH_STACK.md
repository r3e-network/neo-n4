...
| Cross-language tests | **166 passing** (15 TS + 10 Rust SDK + 5 shared execution-core + 7 SP1 guest + 103 watcher with `--features live-rpc` (87 eth + 7 tron + 9 sol) + 22 Foundry (15 single + 7 multi) + 4 Solana router) |
