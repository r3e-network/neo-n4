...
> 对应英文文档：[.github/ISSUE_TEMPLATE/bug_report.md](../../../../.github/ISSUE_TEMPLATE/bug_report.md)
...
- 对应文件：.github/ISSUE_TEMPLATE/bug_report.md
- 中文路径：docs/zh/.github/ISSUE_TEMPLATE/bug_report.md
...
本文件已作为 .github/ISSUE_TEMPLATE/bug_report.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。