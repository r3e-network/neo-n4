# 中文版本：.github/ISSUE_TEMPLATE/feature_request.md

> 对应英文文档：[.github/ISSUE_TEMPLATE/feature_request.md](../../../../.github/ISSUE_TEMPLATE/feature_request.md)
> 维护规则：英文文档发生结构、命令、路径、接口、合约数量、测试证据或安全结论变更时，本中文版本必须同步更新。

## 本页用途

这是 GitHub 协作模板。中文版本用于让中文贡献者理解 issue、PR 或维护流程。

## 中文摘要

- 对应文件：.github/ISSUE_TEMPLATE/feature_request.md
- 中文路径：docs/zh/.github/ISSUE_TEMPLATE/feature_request.md
...
本文件已作为 .github/ISSUE_TEMPLATE/feature_request.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。