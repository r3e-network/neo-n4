# 中文版本：.github/PULL_REQUEST_TEMPLATE.md

> 对应英文文档：[.github/PULL_REQUEST_TEMPLATE.md](../../../.github/PULL_REQUEST_TEMPLATE.md)
...
- 对应文件：.github/PULL_REQUEST_TEMPLATE.md
- 中文路径：docs/zh/.github/PULL_REQUEST_TEMPLATE.md
...
本文件已作为 .github/PULL_REQUEST_TEMPLATE.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。