...
- **测试(1521 .NET + 跨语言门禁)** —— 34 个 .NET 工程的 1521 条测试，加 TypeScript、Rust SDK/core/watchers/zkVM、Python SDK、Node 体验层、vendored `neo-zkvm` / `neo-riscv-vm`、Solidity、Solana 和 SP1 发布证明门禁。
