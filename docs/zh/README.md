...
- **智能合约(25 个 NeoHub + 10 个 L2 原生)** —— 25 个 NeoHub L1 合约项目(24 个生产合约 + 1 个测试 stub,包含 `ContractZkVerifier` 与 immutable `Sp1Groth16Verifier`) + 10 个 L2 原生合约(均经
...
| 1    | NeoHub v0 + 共享桥                   | ✅   | 25 个 NeoHub 项目全部编译;部署计划器输出 24 个生产步骤(15 核心 + ContractZkVerifier + Sp1Groth16Verifier + 2 fraud verifier + 5 外链桥) |
