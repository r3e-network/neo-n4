# 中文版本：Neo N4 Deep Audit Report

> 对应英文文档：[docs/audit/production-readiness-audit.md](../../audit/production-readiness-audit.md)
...
- 对应文件：docs/audit/production-readiness-audit.md
- 中文路径：docs/zh/audit/production-readiness-audit.md
...
本文件已作为 docs/audit/production-readiness-audit.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。