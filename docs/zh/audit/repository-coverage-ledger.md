# 中文版本：Repository Coverage Ledger

> 对应英文文档：[docs/audit/repository-coverage-ledger.md](../../audit/repository-coverage-ledger.md)
...
- 对应文件：docs/audit/repository-coverage-ledger.md
- 中文路径：docs/zh/audit/repository-coverage-ledger.md
...
本文件已作为 docs/audit/repository-coverage-ledger.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。