# 中文版本：Security Audit Report - 2026-05-17

> 对应英文文档：[docs/audit/security-audit-2026-05-17.md](../../audit/security-audit-2026-05-17.md)
...
- 对应文件：docs/audit/security-audit-2026-05-17.md
- 中文路径：docs/zh/audit/security-audit-2026-05-17.md
...
本文件已作为 docs/audit/security-audit-2026-05-17.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。