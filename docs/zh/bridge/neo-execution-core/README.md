# 中文版本：neo-execution-core

> 对应英文文档：[bridge/neo-execution-core/README.md](../../../../bridge/neo-execution-core/README.md)
...
- 对应文件：bridge/neo-execution-core/README.md
- 中文路径：docs/zh/bridge/neo-execution-core/README.md
...
本文件已作为 bridge/neo-execution-core/README.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。