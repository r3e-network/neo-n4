# 中文版本：Neo Core Fork Policy

> 对应英文文档：[docs/core-fork-policy.md](../core-fork-policy.md)
...
- 对应文件：docs/core-fork-policy.md
- 中文路径：docs/zh/core-fork-policy.md
...
本文件已作为 docs/core-fork-policy.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。