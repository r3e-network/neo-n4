# 中文版本：EVM-side bridge contracts

> 对应英文文档：[external/foreign-contracts/eth/README.md](../../../../../external/foreign-contracts/eth/README.md)
...
- 对应文件：external/foreign-contracts/eth/README.md
- 中文路径：docs/zh/external/foreign-contracts/eth/README.md
...
本文件已作为 external/foreign-contracts/eth/README.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。