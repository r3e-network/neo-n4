# 中文版本：Sample L2 chains + custom chain logic

> 对应英文文档：[samples/README.md](../../../samples/README.md)
...
- 对应文件：samples/README.md
- 中文路径：docs/zh/samples/README.md
...
本文件已作为 samples/README.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。