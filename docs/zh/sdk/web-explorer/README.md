# 中文版本：Neo Elastic Network — Web Explorer

> 对应英文文档：[sdk/web-explorer/README.md](../../../../sdk/web-explorer/README.md)
...
- 对应文件：sdk/web-explorer/README.md
- 中文路径：docs/zh/sdk/web-explorer/README.md
...
本文件已作为 sdk/web-explorer/README.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。