...
| 节点基础设施 | 🟡 | 专用 recursive SP1 guest/prover 与 SettlementManager 授权、绑定 finalized constituents 的原子发布路径已交付；独立审计与真实递归证明部署证据仍待完成。 |
...
`Neo.Hub.Deploy` 把整个桥栈与 NeoHub 一起脚手架化:23 个生产部署步骤 + 30 条
