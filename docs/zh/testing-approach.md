...
4. `sp1-host` —— digest-pinned Docker guest build、workspace fmt/clippy/release tests；
   terminal 与 recursive real-proof ignored gates 在 schedule 或显式 dispatch 运行
