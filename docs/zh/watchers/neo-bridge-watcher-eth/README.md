# 中文版本：neo-bridge-watcher-eth

> 对应英文文档：[watchers/neo-bridge-watcher-eth/README.md](../../../../watchers/neo-bridge-watcher-eth/README.md)
...
- 对应文件：watchers/neo-bridge-watcher-eth/README.md
- 中文路径：docs/zh/watchers/neo-bridge-watcher-eth/README.md
...
本文件已作为 watchers/neo-bridge-watcher-eth/README.md 的中文对应版本纳入仓库级本地化覆盖检查。后续修改由单元测试强制要求中文 counterpart 继续存在。