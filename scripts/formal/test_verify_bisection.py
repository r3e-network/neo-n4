"""Check the bisection proof runner's fail-closed behavior and negative controls."""
import tempfile
import unittest
...
import z3
import verify_bisection as verification


class BisectionModelTests(unittest.TestCase):
    ...
    def test_changed_source_requires_review(self):
        ...
        anchor = 'var mid = _lo + (_hi - _lo) / 2;'
        self.assertIn(anchor, source)
        with tempfile.TemporaryDirectory() as directory:
            changed = Path(directory) / "BisectionGame.cs"
