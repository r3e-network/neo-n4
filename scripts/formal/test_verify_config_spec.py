"""Check the config-spec proof runner's fail-closed behavior and negative controls."""
import tempfile
import unittest
...
import z3
import verify_config_spec as verification


class ConfigSpecModelTests(unittest.TestCase):
    def test_all_obligations_and_negative_controls(self):
        ...
        self.assertEqual(12, len(report["obligations"]))
    ...
    def test_changed_source_requires_review(self):
        ...
        anchor = 'private const int OffsetActive = 90;'
        self.assertIn(anchor, source)
        with tempfile.TemporaryDirectory() as directory:
            changed = Path(directory) / "L2ChainConfigSerializer.cs"
    ...
    def test_line_endings_do_not_change_review_digest(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(verification.REVIEWED_SOURCE_SHA256, verification.check_source())
