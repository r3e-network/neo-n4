"""Check the L2-bridge proof runner's fail-closed behavior and negative controls."""
import tempfile
import unittest
...
import z3
import verify_l2_bridge as verification


class L2BridgeModelTests(unittest.TestCase):
    def test_all_obligations_and_negative_controls(self):
        ...
        self.assertEqual(15, len(report["obligations"]))
    ...
    def test_changed_source_requires_review(self):
        ...
        anchor = 'await NativeContract.TokenManagement.BurnInternal(engine, l2Asset, caller, amount,'
        self.assertIn(anchor, source)
        with tempfile.TemporaryDirectory() as directory:
            changed = Path(directory) / "L2NativeContracts.cs"
