"""Check the registration proof runner's fail-closed behavior and negative controls."""
import tempfile
import unittest
...
import z3
import verify_registration as verification
...
class RegistrationModelTests(unittest.TestCase):
    def test_all_obligations_and_negative_controls(self):
        ...
        self.assertEqual(21, len(report["obligations"]))
    ...
    def test_changed_source_requires_review(self):
        ...
        anchor = 'ExecutionEngine.Assert(!genesisStateRoot.Equals(UInt256.Zero), "genesis root must be non-zero");'
