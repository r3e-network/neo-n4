"""Check the settlement proof runner's fail-closed behavior and negative controls."""
import tempfile
import unittest
...
import z3
import verify_settlement as verification
...
class SettlementModelTests(unittest.TestCase):
    ...
    def test_changed_source_requires_review(self):
        ...
        anchor = 'ExecutionEngine.Assert(preStateRoot.Equals(canonicalPre), "pre-state root mismatch");'
