            ...
            ["wireProduction"] = new Dictionary<string, object?>
            {
                ...
                ["recommendedDurableStores"] = new Dictionary<string, object?>
                {
                    ...
                    ["localHostReadiness"] =
                        ...
                        + "IsPipelineEnabled / IsSettlementPoisoned / IsSettlementRetrying / IsSettlementIdle / IsPipelineHealthy / "
                        + "PipelineHealthFailures / HasOverdueForcedInclusion / IsMetricsHttpHealthy / MetricsHttpHealthFailures / "
                    ...
                    ["gatewayHostOpsHelpers"] =
                        ...
                        + "PublicationHealthFailures / IsGatewayHostHealthy / GatewayHostHealthFailures / "
