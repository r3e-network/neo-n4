...
public sealed class UT_OptimisticLocalHostComposition
{
    ...
    public void Open_FromDeployReport_WiresOptimisticLocalStack()
    {
        ...
        try
        {
            ...
            StringAssert.Contains(File.ReadAllText(probePath), "\"isPipelineEnabled\": true");
            StringAssert.Contains(File.ReadAllText(probePath), "\"isBatcherCheckpointAligned\": true");
