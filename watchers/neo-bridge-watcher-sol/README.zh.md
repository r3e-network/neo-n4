...
这些图是 `neo-bridge-watcher-sol` 自己目录下的 crate 专属学习资料，用来说明它在 Neo N4 中的位置、自己负责的技术边界、内部工作流，以及数据如何流经它。
...
- **本 crate 消费:** SOL RPC/log 流、桥合约事件、检查点游标
...
| 类型 | 代表符号 |
| --- | --- |
| 类型 | Ed25519FileSigner |
| 函数 | from_file <br> from_bytes <br> verifying_key |
| Trait | 未扫描到公开符号 |
| 常量 | SOLANA_MAINNET_CHAIN_ID <br> SOLANA_DEVNET_CHAIN_ID <br> SOLANA_TESTNET_CHAIN_ID |
